...
var _ [20 - int(unsafe.Sizeof(BatchEvent{}))]byte
var _ [int(unsafe.Sizeof(BatchEvent{})) - 20]byte
var _ [-int(unsafe.Offsetof(BatchEvent{}.Pid))]byte
var _ [4 - int(unsafe.Offsetof(BatchEvent{}.Comm))]byte
var _ [int(unsafe.Offsetof(BatchEvent{}.Comm)) - 4]byte

type Objects struct {
	collection  *ebpf.Collection
	BatchEvents *ebpf.Map     `ebpf:"BatchEvents"`
...
func LoadObjectsWithOptions(path string, opts LoadOptions) (*Objects, error) {
	...
	if len(opts.Programs) != 0 {
		...
		objects.BatchEvents = collection.Maps["BatchEvents"]
...
func (o *Objects) Close() error {
	...
	var err error
	if o.BatchEvents != nil {
		err = errors.Join(err, o.BatchEvents.Close())
	}
	if o.OnExec != nil {
...
func (o *Objects) ReadBatchEvents(ctx context.Context, handle func(BatchEvent) error) error {
	if o == nil || o.BatchEvents == nil {
		return fmt.Errorf("BatchEvents map is not loaded")
	}
	if ctx == nil {
		ctx = context.Background()
	}
	reader, err := ringbuf.NewReader(o.BatchEvents)
	if err != nil {
		return err
	}
	defer reader.Close()
