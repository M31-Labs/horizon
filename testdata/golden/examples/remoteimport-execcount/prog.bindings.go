...
var _ [32 - int(unsafe.Sizeof(ExecEvent{}))]byte
var _ [int(unsafe.Sizeof(ExecEvent{})) - 32]byte
...
var _ [12 - int(unsafe.Offsetof(ExecEvent{}.Uid))]byte
var _ [int(unsafe.Offsetof(ExecEvent{}.Uid)) - 12]byte
var _ [16 - int(unsafe.Offsetof(ExecEvent{}.Comm))]byte
var _ [int(unsafe.Offsetof(ExecEvent{}.Comm)) - 16]byte
...
func (o *Objects) ReadEvents(ctx context.Context, handle func(ExecEvent) error) error {
